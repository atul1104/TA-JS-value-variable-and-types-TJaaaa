...
let num1 = 21;
let num2 = 32;
alert(`The value of num1 is` + " " + num1 + " " + `and value of num2 is` + " " + num2);
alert(num1 + num2);
...
console.log ( `I am ` + " " + userName + " " + userProfession);
alert( `Username:`+ " "+ userName, "Adult:"+ " "+ isAdult, "Profession:"+ " "+ userProfession);
