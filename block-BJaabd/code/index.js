...
if (age > 12 && age < 55){
  alert("You can participate in marathon");
      ...
      alert("You are too old to participate in marathon");
  }
// Loops
/*
...
*/
// [Your code goes here]
let max = +prompt("Enter the natural number");
let sum = 0;
for ( let i = 1; i <= max; i++){
  sum += i;
}
alert(`the value of sum ${sum}`);
/* Switch Statement
...
switch(operation){
  case "add":
    ...
    break;
      case "sub":
    alert(`sub of ${firstNum} and ${secondNum} is ${firstNum - secondNum} `);
    break;
      case "mul":
    alert(`mul of ${firstNum} and ${secondNum} is ${firstNum * secondNum} `);
    break;
      case "div":
    alert(`div of ${firstNum} and ${secondNum} is ${firstNum / secondNum} `);
    break;
    default:
      alert(`Enter valid input`);
